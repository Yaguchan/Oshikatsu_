...
# python seg_tracking/make_mov.py --mov 61thSingleDance_64_70_1k --member-enjp-list face_identification/member_list/member.csv --font data/font/NotoSansJP-Black.ttf
    ...
    while True:
        ...
        for member_id, seg_mask in ts[frame_count]:
            ...
            if args.jp:
                ...
                draw.rectangle([x1, y1, x1+w, y1+h], outline=(R,G,B), width=2)
